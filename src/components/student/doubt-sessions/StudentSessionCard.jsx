...
export default function StudentSessionCard({ session, onMarkRead, isFirstView = false }) {
  ...
  return (
    <div
      className={`group relative bg-slate-800/60 backdrop-blur-xl rounded-2xl border transition-all duration-300 hover:scale-[1.03] hover:shadow-2xl hover:shadow-teal-500/10 border-slate-700/50 hover:border-teal-500/30`}
    >
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mb-3">
              <div className={`px-3 py-1 rounded-lg text-sm font-medium border ${subjectColorClass}`}>
                {session.subject}
              </div>
            ...
            <div className="space-y-3">
              ...
              {session.adminResponse.meetingLink && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-teal-600 to-blue-600 hover:from-teal-700 hover:to-blue-700 text-white rounded-lg text-sm font-medium transition-all duration-200 hover:scale-105"
                >
