...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-navy-900">
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-20">
          ...
          >
            ...
            <div className="inline-flex items-center px-3 py-2 sm:px-6 sm:py-3 bg-gradient-to-r from-teal-900/60 to-blue-900/60 border border-teal-700/50 rounded-full text-xs sm:text-sm text-teal-300 mb-4 sm:mb-8 backdrop-blur-sm shadow-lg">
              <Zap className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2 text-yellow-400" />
              <span className="font-semibold">Revolutionizing JEE Preparation</span>
            </div>
            ...
            {/* Subheadline */}
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-400 mb-6 sm:mb-8 lg:mb-12 max-w-4xl mx-auto leading-relaxed px-2">
              Revolutionize your JEE preparation with adaptive CBT tests, real-time doubt resolution, and personalized
              learning paths designed specifically for JEE aspirants to maximize success.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center mb-8 sm:mb-12 lg:mb-16 px-4">
              <Button
                ...
                variant="primary"
                size="lg"
                className="group shadow-2xl shadow-teal-900/30 px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg w-full sm:w-auto"
              >
            ...
            <div className="text-center">
              <p className="text-xl sm:text-2xl font-semibold bg-gradient-to-r from-yellow-400 to-teal-400 bg-clip-text text-transparent">
        ...
        <div className="absolute top-10 sm:top-20 left-5 sm:left-10 w-16 sm:w-24 h-16 sm:h-24 bg-gradient-to-r from-teal-600/20 to-blue-600/20 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute bottom-10 sm:bottom-20 right-5 sm:right-10 w-20 sm:w-32 h-20 sm:h-32 bg-gradient-to-r from-yellow-600/20 to-teal-600/20 rounded-full blur-xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/4 w-12 sm:w-16 h-12 sm:h-16 bg-gradient-to-r from-purple-600/15 to-pink-600/15 rounded-full blur-lg animate-pulse delay-500"></div>
      </section>

      {/* Benefits Section */}
      <section className="py-10 sm:py-16 bg-gradient-to-r from-slate-800/40 to-slate-900/40 backdrop-blur-sm border-y border-slate-700/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Features Section */}
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-slate-800/30 to-slate-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
